    ...
    <footer className="footer">
      <div className="footer-columns">
        ...
        <div className="footer-column">
          ...
          <img src={`${process.env.PUBLIC_URL}/images/footer/iphone.png`} alt="app image" className="footer-image" />
          <img src={`${process.env.PUBLIC_URL}/images/footer/google.png`} alt="app image" className="footer-image" />
