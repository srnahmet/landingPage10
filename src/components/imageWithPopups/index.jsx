...
function ImageWithPopups() {
  return (
    <div className="image-container">
      <img src="/images/imageWithPopups/map.png" alt="Background" className="background-image" />

      <h1 className="centered-title">11,658,467</h1>
      <h2 className="centered-title-2">Shoes Collected</h2>

      <div className="popup">
        <img src="/images/imageWithPopups/popup.png" alt="Popup Content" className="popup-image" />
